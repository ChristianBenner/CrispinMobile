 ...
 * @since 1.0
 */
public class LightingBatchShader extends Shader {
    // The resource ID of the vertex file
    public static final int VERTEX_FILE = R.raw.lighting_vert_instances;
    ...
    public LightingBatchShader() {
        ...
        instanceMatrixAttributeHandle = getAttribute("aInstanceMatrix");
