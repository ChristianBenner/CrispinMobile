...
public class InstanceLightingShader2D extends Shader {
    // The resource ID of the vertex file
    public static final int VERTEX_FILE = R.raw.instance_lighting_2d_vert;

    // The resource ID of the fragment file
    public static final int FRAGMENT_FILE = R.raw.instance_lighting_2d_frag;
     ...
     * @since 1.0
     */
    public InstanceLightingShader2D() {
        super("Instance Lighting Shader 2D", VERTEX_FILE, FRAGMENT_FILE);
