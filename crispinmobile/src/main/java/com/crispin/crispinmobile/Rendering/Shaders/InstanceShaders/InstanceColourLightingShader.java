...
public class InstanceColourLightingShader extends Shader {
    // The resource ID of the vertex file
    public static final int VERTEX_FILE = R.raw.instance_colour_lighting_vert;

    // The resource ID of the fragment file
    public static final int FRAGMENT_FILE = R.raw.instance_colour_lighting_frag;
     ...
     * @since 1.0
     */
    public InstanceColourLightingShader() {
        super("Instance Colour Lighting Shader", VERTEX_FILE, FRAGMENT_FILE);
