...
/**
 * LightingShadowShader2D is a built in shader designed to render 2D objects with lighting that can
 ...
 * @since 1.0
 */
public class LightingShadowAmbientMapShader2D extends Shader {
    ...
    public static final int FRAGMENT_FILE = R.raw.lighting_shadows_ambient_map_frag_2d;

    // Maximum number of point lights supported by the shader
    private static final int MAX_NUM_POINT_LIGHTS = 10;

    // Tag for the logger
    private static final String TAG = "LightingShadowAmbientMapShader2D";

    // Ambient texture uniform handle
    public int ambientTextureUniformHandle = UNDEFINED_HANDLE;

    /**
     * Create the LightingShadowShader2D. This compiles the pre-defined vertex and fragment
     * shader's, and links the attributes to the shader base class for a common form of user
     * interaction.
     *
     * @since 1.0
     */
    public LightingShadowAmbientMapShader2D() {
