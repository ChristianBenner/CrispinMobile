...
public class InstanceColourLightingShader2D extends Shader {
    ...
    public static final int VERTEX_FILE = R.raw.instance_colour_lighting_vert_2d;

    // The resource ID of the fragment file
    public static final int FRAGMENT_FILE = R.raw.instance_colour_lighting_frag_2d;
