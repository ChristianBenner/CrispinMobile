...
public class InstanceLightingShader extends Shader {
    ...
    public static final int VERTEX_FILE = R.raw.instance_lighting_vert;

    // The resource ID of the fragment file
    public static final int FRAGMENT_FILE = R.raw.instance_lighting_frag;
     ...
     * @since 1.0
     */
    public InstanceLightingShader() {
        super("Instance Lighting Shader", VERTEX_FILE, FRAGMENT_FILE);
