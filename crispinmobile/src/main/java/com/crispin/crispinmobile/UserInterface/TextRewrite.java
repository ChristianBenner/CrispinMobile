 ...
 * @since 1.0
 */
public class TextRewrite implements UIElement {
    // Tag used in logging
     ...
     * @since 1.0
     */
    public TextRewrite(Font font, String textString, boolean wrapWords, boolean centerText,
     ...
     * @since 1.0
     */
    public TextRewrite(Font font, String textString, float maxLineWidth) {
     ...
     * @since 1.0
     */
    public TextRewrite(Font font, String textString) {
